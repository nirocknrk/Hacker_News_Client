...
import hn.nrk.com.hackernewsclient.StoryActivity;
import hn.nrk.com.hackernewsclient.model.HNStory;
import hn.nrk.com.hackernewsclient.views.activity.BookmarksActivity;
import hn.nrk.com.hackernewsclient.views.activity.NewsActivity;
import hn.nrk.com.hackernewsclient.views.activity.SettingsActivity;
import hn.nrk.com.hackernewsclient.views.activity.comments.CommentsActivity;
import hn.nrk.com.hackernewsclient.views.activity.comments.CommentsPresenter;
import hn.nrk.com.hackernewsclient.views.transitions.TransitionHelper;
...
public class Navigator {
    ...
    public Navigator(HNActivity activity) {
    ...
    public void toInnerBrowser(final HNStory story) {
        if (isOnline()) {
            mSubscriptions.add(
    ...
    private void openCustomTabsIfPossible(final HNStory story, IntentCustomizer intentCustomizer) {
        SimpleChromeCustomTabs.getInstance().withFallback(
                new NavigationFallback() {
                    ...
                    public void onFallbackNavigateTo(Uri url) {
                        ...
                        articleIntent.putExtra(StoryActivity.ARG_STORY, story);                        ActivityCompat.startActivity(activity, articleIntent, null);
                    }
                }
        )
    ...
    public void toComments(View v, HNStory story) {
    ...
    public void toComments(HNStory story) {
        Intent commentIntent = new Intent(activity, CommentsActivity.class);
        commentIntent.putExtra(CommentsActivity.ARG_STORY, story);
