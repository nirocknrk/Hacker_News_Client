...
import hn.nrk.com.hackernewsclient.model.Comment;
...
public class CommentsAdapter extends CursorRecyclerAdapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolderCursor(RecyclerView.ViewHolder holder, Cursor cursor) {
        ...
        if (holder instanceof CommentViewHolder) {
            ((CommentViewHolder) holder).bind(comment, mSharedPreferences, listener);
        } else {
            ((HeaderViewHolder) holder).bind(comment, mSharedPreferences, listener, type);
        }
    ...
    public static class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View view) {
            ...
            text = (TextView)Views.findById(view, R.id.comment_header_text);
            author = (TextView)Views.findById(view, R.id.comment_header_by);
            when = (TextView)Views.findById(view, R.id.comment_header_when);
        ...
        public void bind(final Comment comment, SharedPreferences loginSharedPreferences, final Listener listener, String type) {
...
//            }
    ...
    public static class CommentViewHolder extends RecyclerView.ViewHolder {
        ...
        public void bind(final Comment comment, SharedPreferences loginSharedPreferences, final Listener listener) {
            text.setText(Html.fromHtml(comment.getText()));
            text.setMovementMethod(LinkMovementMethod.getInstance());
            author.setText(comment.getBy());
            when.setText(comment.getTimeText());
