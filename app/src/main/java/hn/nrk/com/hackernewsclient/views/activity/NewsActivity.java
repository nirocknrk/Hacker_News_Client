...
public class NewsActivity extends NewsNaviDrawerActivity implements NewsListener, ActionBarDrawerListener.Listener,  GoogleApiClient.OnConnectionFailedListener {
    ...
    public void showLoginExpired() {
        snackbarView.showSnackBar("login_expired_")
                .withBackgroundColor(R.color.black, croutonBackgroundAlpha)
                .withAnimationDuration(croutonAnimationDuration)
