...
public abstract class StoryFragment extends NewsFragment implements SwipeRefreshLayout.OnRefreshListener, ViewDelegate {
    ...
    protected abstract HNStory.FILTER getType();
