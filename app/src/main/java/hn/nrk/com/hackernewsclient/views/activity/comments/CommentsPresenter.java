...
import hn.nrk.com.hackernewsclient.views.StoryHeaderView;
...
//    private ReplyView replyView;
    ...
    public CommentsPresenter(HNActivity activity, SwipeRefreshLayout.OnRefreshListener refreshListener) {
...
//        replyView.setListener(this);
        SharedPreferences = HNSharedPreferences.newInstance();
...
//    }
    ...
    private void showAddedBookmarkSnackbar(final CommentsOperator commentsOperator, final HNStory story) {
    ...
    private void showRemovedBookmarkSnackbar(final CommentsOperator commentsOperator, final HNStory story) {
...
//        hideReplyView();
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        Uri commentsUri = FeedContract.CommentsEntry.buildCommentsUri();

        return new CursorLoader(
                activity,
                commentsUri,
                FeedContract.CommentsEntry.COMMENT_COLUMNS,
